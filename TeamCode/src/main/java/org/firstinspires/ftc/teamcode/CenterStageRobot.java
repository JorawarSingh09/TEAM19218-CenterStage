...
public class CenterStageRobot {
	...
	private void telemetry(){
		...
		telemetry.addData("Linear Slide Position left/right: ", "%d, %d", linearSlides.getPosition()[0], linearSlides.getPosition()[1]);
...
//        }
	...
	public void drivePosition(){
		driveStop();
		if(robotState == RobotState.PickupPosition && grabberArm.getGrabberState() == GrabberState.CLOSED){
